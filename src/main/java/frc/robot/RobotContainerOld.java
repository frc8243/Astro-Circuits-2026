...
import frc.robot.subsystems.ShooterSystemOld;
 ...
 */
public class RobotContainerOld {
    ...
    private void configureBindings() {
        ...
        //operatorXbox.a().whileTrue(shooter.runShooterCommand();
        //operatorXbox.a().whileTrue(shooter.runShooterCommand();
        ...
        // operatorXbox.a().whileTrue(Commands.run(()->
        // shooter.shooterMotor.set(0.5)));//.whileFalse(shooter.setDutyCycle(0));
